...
if ($getAction == "add") {
    $task = new TDLTaskClass(trim(filter_input(INPUT_POST, "task", FILTER_SANITIZE_STRING)), filter_input(INPUT_POST, "deadline", FILTER_SANITIZE_STRING));
    $task->testAndAddProjectLabels($mysqli, $_SESSION["username"]);
